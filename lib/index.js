...
function apply(ctx, config) {
  ctx.tools.register(defineTool({
    ...
    parameters: {
      ...
      targets: { type: "object", description: "Target weights in percent summing to 100, e.g. {\"equity\": 60} (portfolio)." },
      values: { type: "object", description: "Current market values per asset, e.g. {\"equity\": 50000} (portfolio)." },
